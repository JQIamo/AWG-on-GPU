...
extern const double ramp_time = 0.01;
const int max_streaming_tweezers = 5;
double static_freq[4][16384]={{10000000,20000000,30000000,40000000,50000000},
    {100000000,110000000,120000000},
    {},
    {70000000}};
double destination_freq[4][16384]={{100000000},
    {130000000,140000000},
    {},
    {}};
unsigned int tone_count[5];
unsigned int dynamic_tone_count[5];
int dynamic_list[16384] = {0,5,6};   // Index of tones that is to be moved
